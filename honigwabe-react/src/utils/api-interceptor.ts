...
/**
 * Wrapper für fetch() mit automatischem Logout bei Auth-Fehlern
 */
  ...
  try {
    ...
    if (response.status === 401 || response.status === 403) {
      ...
      if (typeof window !== 'undefined') {
        // Verwende setTimeout um sicherzustellen dass der State aktualisiert wurde
        setTimeout(() => {
...
/**
 * Behandelt API-Fehler mit automatischem Logout
 */
