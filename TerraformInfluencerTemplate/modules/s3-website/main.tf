...
# ACM Zertifikat (us-east-1 für CloudFront)
...
resource "aws_route53_record" "cert_validation" {
  for_each = {
    for dvo in tolist(aws_acm_certificate.website.domain_validation_options) : dvo.domain_name => {
